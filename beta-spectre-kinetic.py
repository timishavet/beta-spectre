...
Q = 0.5788      # энергия распада в МэВ (можно изменить) (также максимальная кинетическая энергия частицы)
p_max = np.sqrt((Q + m_e)**2 - m_e**2) # максимальный импульс частицы
...
p_range = np.linspace(0.01, p_max, 500)  # импульс в МэВ/c
